...
def main():
    ...
    st.markdown(f'We can set a OU process with initial random parameters such as alpha: {np.round(std,4)}, Omega: {np.round(mean,4)}, beta: {reversion_m}. Note that Omega is the long-term mean,\
